...
const ROUTES = [
  '/',
  '/productos',
  '/productos/iluminacion/bull',
  '/productos/iluminacion/lupe',
  '/productos/iluminacion/sassy',
  '/productos/macetas/macetaCilindrica',
  '/productos/mesas/albert',
  '/productos/mesas/alec',
  '/productos/mesas/ayn',
  '/productos/mesas/baut',
  '/productos/mesas/edgy',
  '/productos/mesas/lula',
  '/productos/mesas/pili',
